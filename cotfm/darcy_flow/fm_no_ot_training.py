...
def parse_args():
    ...
    parser.add_argument("--wandb_project_name", type=str, default="minibatch-FFM", help="Weights & Biases project name (default: FFM)")
...
def main():
    ...
    torch.save(si.model.state_dict(), f'../darcy_flow/trained_models/ffm/si_{run.id}_final.pth')
